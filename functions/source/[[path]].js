...
//  5. 2026-09-05：quick tunnel 又两次在客户端握手后被 CF 边缘断开（老版本
//     cloudflared + 无凭据模式的固有问题），最终改为账号内命名隧道
//     mc-icon-proxy → icons.coldrain.ink。域名由 DNS CNAME 固定指向隧道，
//     隧道重连/重启/升级镜像均不影响回源地址。
//
